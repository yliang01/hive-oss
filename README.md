...
| HTTP API | `cc.cc3c.hive.oss.controller.HiveOssController` | REST 接口，详见 [静态前端](static-frontend.md) 与 `src/main/resources/static/API.md` |
...
| 静态前端 | [static-frontend.md](static-frontend.md) | Bucket/文件管理页面与 API 调用 |
